...
public interface CacheService {
	...
	void putNoTime(String cacheName, String key, String value);

	void putNoTime(String cacheName, String key, Object value);
	...
	void remove(String cacheName, List<String> keys);
	...
	List getAllKeyAndValue(String cacheName, int numPerPage, int pageNum, Long totalCount);
