 ...
 * 类描述：拉取旧mongo 订单数据 <br/>
 * 创建时间：2017年05月20日 下午7:17:10 <br/>
 * 
 * @author zlp
 * @version V1.0
 */
@Service("syncEncrptTradeDataHandler")
public class SyncEncrptTradeDataHandler implements Handler {

	private static final Logger loger = Logger.getLogger(SyncEncrptTradeDataHandler.class);
...
//          synchronousTradeHelper.syncEncrptTradeData(map);
	    
	      loger.info("查询旧mongo总共处理时间"+(System.currentTimeMillis()-startTime)+"毫秒");
	}
}
