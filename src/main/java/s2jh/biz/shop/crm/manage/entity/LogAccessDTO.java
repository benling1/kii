...
import s2jh.biz.shop.crm.manage.handler.LogAccessHandler;
...
public class LogAccessDTO implements Serializable {
    ...
    private String appName = LogAccessHandler.TOP_APP_NAME;
    private String topAppKey = LogAccessHandler.TOP_APP_KEY;
    private String time ;
