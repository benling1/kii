...
import s2jh.biz.shop.crm.view.service.HttpService;
...
public class LogAccessHandler extends LogAccessForwardHandler {
    ...
    public static String LOG_APP_KEY = "68756833";
    public static String LOG_APP_SECRET="dZmVaggY77tBCVu0uVCM";
    public static String URL="http://gw.ose.aliyun.com/event";
    public static String TOP_APP_KEY="21800702";
    public static String TOP_APP_NAME="客云CRM";
    ...
    protected void log(Map map) {
        ...
        logger.info("日志上传结果为："+httpResult);
    }
