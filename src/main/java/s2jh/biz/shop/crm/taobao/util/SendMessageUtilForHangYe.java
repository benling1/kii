 ...
 * Date:     2017年3月16日 下午5:51:39 <br/> 
 * @author   zlp
 * 订单及测试短信接口调用类
 * @version   1.0     
 */

public class SendMessageUtilForHangYe {

	private static final Log logger = LogFactory.getLog(SendMessageUtilForHangYe.class);
	
	public static   String USERCODE ="keyuncs";
