...
public class SendMessageIndexUtil {
	...
	private static Logger logger = LoggerFactory.getLogger(SendMessageIndexUtil.class);

	private final static String YZM_USERNAME = "keyuncs";
	private final static String YZM_PASSWORD = "ceshi";
