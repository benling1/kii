...
public class OverallSituationItemThreadPool {
	private  static int threadCount = 50;
	private OverallSituationItemThreadPool(){};
	//private final static ExecutorService tradeThreadPool = Executors.newFixedThreadPool(100);  
	private final static ExecutorService quanItemThreadPool = new ThreadPoolExecutor(10, threadCount, 15 * 2, TimeUnit.SECONDS,
	 ...
	 * @return
	 */
	public static ExecutorService  quanItemThreadPool(){
		return quanItemThreadPool; 
	}
}
