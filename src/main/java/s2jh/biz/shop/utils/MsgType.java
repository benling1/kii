...
public class MsgType {
	...
	private MsgType(){}
		 ...
		 * 31-等待退货 32-拒绝退款 33-会员短信群发 34-指定号码群发 35-订单短信群发 36-会员互动"
		 * */
	...
	public static final String SYSTEM_SMS_EXPEDITING = "expedite_count_notice";
	//3 短信余额不足报警：剩余条数不足*条开始提醒
	public static final String SYSTEM_SMS_SMSCOUNT = "sms_count_notice";
	//4软件过期提醒 
	public static final String SYSTEM_SMS_SERVICEEXPIRE = "service_expire_notice";
	//5最新促销活动通知 
