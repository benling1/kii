package s2jh.biz.shop.utils.phoneRegExp;
...
//	private static  Pattern pattern = Pattern.compile("^(13[0-9]|14[5,7]|15[0-3,5-9]|166|17[6-8]|18[0-9]|19[8,9])\\d{8}$");
