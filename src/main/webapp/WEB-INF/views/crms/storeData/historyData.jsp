				...
				<div class="w1645  m_l30">
					...
					<div class="m_b30">
						...
						<div class="w1605 bgc_fff p_t35 p_l40 p_b40 viphd_in">
							...
							<!--------查询设置-------->
							<form action="${ctx}/crms/storeData/historyData" method="post">
							...
							<div class="font14 c_384856 h52 lh52">
								...
								<div class="f_l position_relative">
									<!-- <input class="bgc_f4f6fa border0 w240 p_l10 h50 m_r10" type="text" name="beginTime" id="tser01"  readonly onclick="$.jeDate('#tser01',{insTrigger:false,isTime:true,format:'YYYY-MM-DD'})"> -->
									<input class="bgc_f4f6fa border0 w240 p_l10 h50 m_r10" type="text" id="tser01"  readonly onclick="$.jeDate('#tser01',{insTrigger:false,isTime:true,format:'YYYY-MM-DD',choosefun:function(elem, val) {valiteTwoTime();}})" 
								...
								<div class="f_l position_relative">
									<!-- <input class="bgc_f4f6fa border0 w240 p_l10 h50 m_l10 m_r40" type="text" name="endTime" id="tser02"  readonly onclick="$.jeDate('#tser02',{insTrigger:false,isTime:true,format:'YYYY-MM-DD'})"> -->
									<input class="bgc_f4f6fa border0 w240 p_l10 h50 m_l10 m_r40" type="text" id="tser02"  readonly onclick="$.jeDate('#tser02',{insTrigger:false,isTime:true,format:'YYYY-MM-DD',choosefun:function(elem, val) {valiteTwoTime();}})"
							...
							<div>
								...
								<div class="c_384856 text-center data_change_in">
									<table>
									  ...
									  <c:forEach items="${shopDataStatistics2}" var="shopData">
									  <tr>
									    <td>${shopData.dataType}</td>
									    <td><fmt:formatNumber value="${shopData.changeQuantity}" pattern="#.##" type="number" /><%-- ${shopData.changeQuantity} --%></td>
									  </tr>
									  </c:forEach>
									</table>
								</div>
