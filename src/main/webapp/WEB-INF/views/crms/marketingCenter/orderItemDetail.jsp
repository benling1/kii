	...
	<div class="w1903 h100_">
		...
		<!----------下部---------->
				...
				<div class="w1605 bgc_fff p_t35 p_l40 p_b40 text_designate_in position_relative three">
					<form id="formId" action="${ctx}/order/itemIndex" method="post">
...
<script>
	...
	$('.chakan').click(function(){
		...
		window.location.href = "${ctx}/order/customerIndex?itemId=" +　itemId;
	})
	...
	$('.check_this').click(function(){
		...
		window.location.href = "${ctx}/order/effectPicture?msgId=" + $(this).children('input').val();
	})
