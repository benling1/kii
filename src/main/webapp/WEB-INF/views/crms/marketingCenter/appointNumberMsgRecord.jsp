		...
		<!----------下部---------->
				...
				<div class="w1605 bgc_fff p_t35 p_l40 p_b40 text_designate_in position_relative four">
					...
					<div style="line-height: 2.5vw;">
						<form id="formId" action="${ctx}/appointNumber/msgSendRecord" method="post">
...
<script>
	...
	$('.check_this').click(function(){
		...
		if(thisStatus == '4'){
			...
			$(".hide_this").show();
			var ctxVal = $('#ctx').val();
			window.location.href = ctxVal + "/appointNumber/effectIndex?msgId=" + $(this).children('input').val();
		}
	})
