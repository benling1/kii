			...
			<div class="w100_ h50 lh50 bgc_fff font18">
				...
				<div class="w1660  bgc_f1f3f7 c_384856">
					...
					<ul class="h40 m_t1_7 font14 p_l40">
						...
						class="f_l w140 text-center h40 l_h40 bgc_fff  cursor_ ">常规催付效果分析</li></a>
						<%-- <a href="${ctx}/orderEffectECIndex" class="c_384856"><li 
						class="f_l w140 text-center h40 l_h40 bgc_e3e7f0  cursor_ ">二次催付效果分析</li></a>
				...
				<div class="bgc_fff"style="padding-left: 5vw;padding-top: 2vw;">
					...
					<form id="subForm" action="${ctx}/orderEffectIndexData" method="post">
						...
						<div class="f_l position_relative">
							<input type="text" style="border: 1px solid #cad3df;" name="bTime" class="bgc_fff w230 p_l10 h50 m_r10"   id="tser01" readonly="true" value="${beginTime}">
							<img style="width:1vw;" class="position_absolute right20 top15" src="${ctx}/crm/images/date_copy.png"/>
						</div>
						<div class="f_l lh50">~</div>
						<div class="f_l position_relative">
							<input style="border: 1px solid #cad3df;" name="eTime" class="bgc_fff border0 w230 p_l10 h50 m_l10 m_r40" value="${endTime}" type="text" id="tser02" readonly="true" >
					...
					<div class="f_l">
						<table border="0" class="font14 item_table" style="margin-top:3.5vw;">
							...
							<tr>
								...
								<td style="width: 8vw;" class=" h60 text-center money3"><fmt:formatNumber type="percent" value="${earningsMoneyRate}" maxFractionDigits="2"></fmt:formatNumber></td>
							</tr>
						</table>
						<table border="0" class="font14 item_table" style="margin-top:5vw;">
							...
							<tr>
								...
								<td style="width: 8vw;" class=" h60 text-center order3"><fmt:formatNumber type="percent" value="${earningsOrderRate}" maxFractionDigits="2"></fmt:formatNumber></td>
							</tr>
						</table>
						<table border="0" class="font14 item_table" style="margin-top:5vw;">
							<tr class="bgc_e3e7f0">
...
<script type="text/javascript">
	...
	$(function(){
		...
		chart(dataList,'常规催付效果分析图');
		$('#tser01,#tser02').on('click',function(){
			console.log(1);
		});

		$('#tser01').on('click',function(e){

			$.jeDate('#tser01',{trigger:false,isTime:true,format:'YYYY-MM-DD hh:mm:ss'})
		});
		$('#tser02').on('click',function(e){

			$.jeDate('#tser02',{trigger:false,isTime:true,format:'YYYY-MM-DD hh:mm:ss'})
		});
