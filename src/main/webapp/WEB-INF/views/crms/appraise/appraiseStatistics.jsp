	...
	<div class="w1903 h100_">
		...
		<div class="w1703 m_l200">
			...
			<div class="w1660 m_t70 m_l30 ">
				...
				<div class="w1660  bgc_f1f3f7 c_384856">
					...
					<ul class="h40 p_t40 font14  p_l40">
						...
						<li class="f_l w140 text-center h40 l_h40 bgc_fff cursor_"><a
							class="c_384856 " href="${ctx}/rangeQuery?filtrateTime=最近7天">中差评统计</a></li>
				...
				<!-- 中差评统计-->
				<div class=" ping_2">
					<div class="w1660 h1100 bgc_fff">
						<div class="w1290 h1100 font14">
							<form action="${ctx}/rangeQuery" method="post">
								<div class=" w1290 p_l70 h40 p_t40 l_h40">
									...
									<div class="f_l position_relative">
										<input name="beginTime"
											class="bgc_f4f6fa border0 w240 p_l10 h50 m_r10" type="text"
											id="tser07" readonly
									...
									<div class="f_l position_relative">
										<input name="endTime"
											class="bgc_f4f6fa border0 w240 p_l10 h50 m_l10 m_r40"
							...
							<div class="w810 h50 p_t40 p_l70">
								<div
									class="tongji1  w100 h40 border_d9dde5 b_radius5 text-center f_l l_h40 c_fff cursor_ bgc_00a0e9">
									中差评数</div>
								<div
									class="tongji1 w100 h40 border_d9dde5 b_radius5  text-center f_l l_h40 c_8493a8 cursor_">
									中评数</div>
								<div
									class="tongji1 w100 h40 border_d9dde5 b_radius5  text-center f_l l_h40 c_8493a8 cursor_">
									差评数</div>
								...
								<div class="w1280 h480 p_l70 p_t20">
									<table class="text-center font14">
										...
										<tr class=" h55 bgc_f4f4f4 ">
											...
											<td class="w470 bgc_f4f4f4">${ratedVo.bad}</td>
											<td class="w470 bgc_f4f4f4">${ratedVo.volume}</td>
									...
									<table class="text-center font14 m_t20">
										...
										<c:forEach items="${pagination.list}" var="ratedVoList">
											<tr class=" h55 bgc_fafafa ">
												<td class="w260 bgc_fafafa"><fmt:formatDate
														value='${ratedVoList.created}' pattern='yyyy-MM-dd' /></td>
							...
							<div class="display_none tongji2">
								...
								<div id="container1" class="w1290 h380 p_l70 p_t20">曲线图2</div>
							...
							<div class="display_none tongji2">
								...
								<div id="container2" class="w1290 h380 p_l70 p_t20">曲线图2</div>
...
<script>
	$(function(){
		...
		//window.location.href="${ctx}/rangeQuery?filtrateTime=最近7天";
	})
	...
	function addFiltrateTime(data){
		...
		window.location.href="${ctx}/rangeQuery?filtrateTime="+filtrateTime;
...
//-----------------------------------中差评数曲线图-------------------------------------
     $(function(){
	    ...
	    $('#container').highcharts({
	        ...
	        yAxis: {
	            title: {
	                text: 'Middle and bad statistics (条)'
	            },
	            plotLines: [{
	                value: 0,
	                width: 1,
