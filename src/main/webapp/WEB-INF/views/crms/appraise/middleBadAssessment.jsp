				...
				<div class="w1660 m_t70 m_l30 ">
                    ...
                    <div class="w1660  bgc_f1f3f7 c_384856 " >
                        ...
                        <ul class="h40 p_t40 font14 p_l40">
                            ...
                            <%-- <li class="f_l w140 text-center h40 l_h40 bgc_fff ping_1 cursor_"><a class="c_384856 display_block"  href="${ctx}/crms/appraise/middleBadAssessment?filtrateTime="+filtrateTime>中差评统计</a></li> --%>
                    ...
                    <div class=" ping_2">
                    	<div class="w1660  bgc_fff">
                    		<div class="w1290  font14">
                    			<form action="${ctx}/crms/appraise/middleBadAssessment" method="post">
                    			<div class=" w1290 p_l70 h40 p_t40 l_h40">
									...
									<div class="f_l position_relative">
										<!-- <input name="beginTime"  class="bgc_f4f6fa border0 w240 p_l10 h50 m_r10" type="text" id="tser01"  readonly onclick="$.jeDate('#tser01',{insTrigger:false,isTime:true,format:'YYYY-MM-DD hh:mm:ss',choosefun:function(elem, val){valiteTwoTime();},okfun:function(elem, val) {valiteTwoTime();}})"> -->
									...
									<div class="f_l position_relative">
										<!-- <input name="endTime" class="bgc_f4f6fa border0 w240 p_l10 h50 m_l10 m_r40" type="text" id="tser02"  readonly onclick="$.jeDate('#tser02',{insTrigger:false,isTime:true,format:'YYYY-MM-DD hh:mm:ss',choosefun:function(elem, val){valiteTwoTime();},okfun:function(elem, val) {valiteTwoTime();}})"> -->
                    			...
                    			<%-- <div class="w810 h50 p_t40 p_l70">
	                    		    <div >
								    	<a href="${ctx}/crms/appraise/middleBadAssessment?filtrateTime=最近7天" class="  w100 h40 border_d9dde5 b_radius5 text-center f_l l_h40 c_fff cursor_ bgc_00a0e9">	中差评数</a>
							        </div>
							        <div >
								    	<a href="${ctx}/crms/appraise/middleAssessment?filtrateTime=最近7天" class=" w100 h40 border_d9dde5 b_radius5  text-center f_l l_h40 c_8493a8 cursor_">	中评数</a>
							        </div>
							        <div >
	                    			...
	                    			<div class="w1280  p_l70 p_t20" style="margin-bottom:1vw;">
											...
											<c:if test="${pagination.list.size()!=0}">	 
										      <c:forEach items="${pagination.list}" var="ratedVoList"> 
												<tr class=" h55 bgc_fafafa ">
													<td class="w260 bgc_fafafa"><fmt:formatDate value='${ratedVoList.created}' pattern='yyyy-MM-dd' /></td>
													<td class="w310 bgc_f4f4f4">${ratedVoList.neutral}</td>
													<td class="w320 bgc_fafafa">${ratedVoList.bad }</td>
													<td class="w340 bgc_f4f4f4">${ratedVoList.volume}</td>
												</tr>
											  </c:forEach>
											</c:if>
											</table>
                    			...
                    			<!--  中评数  -->
                    			<div class="display_none tongji2">
	                    			<div class="w1290 h380 p_l70 p_t20">
	                    				曲线图2
	                    			</div>
	                    			
	                    			<div class="w1280 h480 p_l70 p_t20">
	                    					<table class="text-center font14">
										        <tr class=" h55 bgc_f1f3f7 ">
													<td class="w140 bgc_f1f3f7"></td>
													<td class="w190 bgc_f1f3f7"></td>
													<td class="w190 bgc_f1f3f7"></td>
													<th class="w190 bgc_f1f3f7">查询汇总</th>
													<td class="w190 bgc_f1f3f7"></td>
													<td class="w190 bgc_f1f3f7"></td>
													<td class="w140 bgc_f1f3f7"></td>
												</tr>
												...
												<tr class=" h55 bgc_fafafa ">
													<td class="w140 bgc_fafafa">中评数</td>
													<td class="w190 bgc_fafafa">差评数</td>
													<td class="w190 bgc_fafafa">中差评总数</td>
													<td class="w190 bgc_fafafa">修改评价数</td>
													<td class="w190 bgc_fafafa">修改率</td>
													<td class="w190 bgc_fafafa">删除评价数</td>
													<td class="w140 bgc_fafafa">删除率</td>
												</tr>
												<tr class=" h55 bgc_f4f4f4 ">
													<td class="w140 bgc_f4f4f4"></td>
													<td class="w190 bgc_f4f4f4"></td>
													<td class="w190 bgc_f4f4f4"></td>
													<td class="w190 bgc_f4f4f4"></td>
													<td class="w190 bgc_f4f4f4"></td>
													<td class="w190 bgc_f4f4f4"></td>
											...
											<table class="text-center font14 m_t20">
										        <tr class=" h55 bgc_f1f3f7 ">
													<td class="w120 bgc_f1f3f7">统计日期</td>
													<td class="w145 bgc_f1f3f7">中评数</td>
													<td class="w160 bgc_f1f3f7">差评数</td>
													<td class="w165 bgc_f1f3f7">中差评总数</td>
													<td class="w180 bgc_f1f3f7">修改评价数</td>
													<td class="w160 bgc_f1f3f7">修改率</td>
													<td class="w165 bgc_f1f3f7">删除评价数</td>
													<td class="w140 bgc_f1f3f7">删除率</td>
												</tr>
										        
												<tr class=" h55 bgc_fafafa ">
													<td class="w120 bgc_fafafa"></td>
													<td class="w145 bgc_fafafa"></td>
													<td class="w160 bgc_fafafa"></td>
													<td class="w165 bgc_fafafa"></td>
													<td class="w180 bgc_fafafa"></td>
													<td class="w160 bgc_fafafa"></td>
													<td class="w165 bgc_fafafa"></td>
													<td class="w140 bgc_fafafa"></td>
												</tr>
												<tr class=" h55 bgc_f4f4f4 ">
													<td class="w120 bgc_f4f4f4"></td>
													<td class="w145 bgc_f4f4f4"></td>
													<td class="w160 bgc_f4f4f4"></td>
													<td class="w165 bgc_f4f4f4"></td>
													<td class="w180 bgc_f4f4f4"></td>
													<td class="w160 bgc_f4f4f4"></td>
													<td class="w165 bgc_f4f4f4"></td>
													<td class="w140 bgc_f4f4f4"></td>
												</tr>
...
// 		} 
	...
	function addFiltrateTime(data){
		...
		//数据回显时使用
		 ...
		 var filtrateTime = $('#filtrateTime').val();
		if(filtrateTime=='最近7天'){
			window.location.href="${ctx}/crms/appraise/middleBadAssessment?filtrateTime=最近7天";
		}else if(filtrateTime=='最近15天'){
		    window.location.href="${ctx}/crms/appraise/middleBadAssessment?filtrateTime=最近15天";
		}else if(filtrateTime=='最近一个月'){
			window.location.href="${ctx}/crms/appraise/middleBadAssessment?filtrateTime=最近一个月";
		}else{
			window.location.href="${ctx}/crms/appraise/middleBadAssessment?filtrateTime="+filtrateTime;
		} 
		 /* window.location.href="${ctx}/crms/appraise/middleBadAssessment?filtrateTime="+filtrateTime; */
...
//-----------------------------------中差评数曲线图-------------------------------------
    <%-- $(function(){
	    ...
	    $('#container').highcharts({
	        ...
	        subtitle: {
	            text: 'Middle and bad statistics',
	            x: 0
	        },
	        xAxis: {
