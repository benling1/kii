...
<!--<script src="js/fukuanguanhuai.js" type="text/javascript" charset="utf-8"></script>-->
<!--<script type="text/javascript" src="js/changguicuifu.js"></script>-->
<script src="${ctx}/crm/js/xiadanguanhuai.js" type="text/javascript"
			...
			<div class="w1660 m_t70 m_l30">
				...
				<div class="w1660  bgc_f1f3f7 c_384856 ">
					...
					<div class="p_l40 p_t27">
						<p class="font20">付款关怀</p>
						<p class="font14 p_t8">买家付款后立即发送短信提醒买家防止诈骗行为，提高客户体验</p>
						<div class="h40 ">
							<div
				...
				<div class="bgc_f1f3f7" style="width: 84.5vw; padding-left: 2vw;">
					<ul class="h40 font14" style="padding-top: 3vw;">
						<a href="${ctx}/paymentCare/queryPaymentCare" class="c_384856">
							<li class="f_l w140 text-center h40 l_h40 bgc_fff cursor_ ">付款提醒</li>
						</a>
				...
				<div class=" bgc_fff">
					...
					<div class="head_li h180">
						<div class="font16 m_l80 c_384856 change_1 position_absolute">
							<p class="m_t40 font14">
								通知时间：<span class="m_l20"><span class="settime1">${orderSetupPayment.startTime }</span>
									~ <span class="settime2">${orderSetupPayment.endTime }</span></span>
							</p>
							<p class="m_t40 font14">
								实付金额：<span class="m_l20 total_money"> <c:choose>
										<c:when
											test="${orderSetupPayment.payAmtOne==null && orderSetupPayment.payAmtTwo==null }">
											不限
								    </c:when>
										<c:when test="${orderSetupPayment.payAmtOne==null}">
											0元~${orderSetupPayment.payAmtTwo }元
								    </c:when>
										<c:when test="${orderSetupPayment.payAmtTwo==null}">
											${orderSetupPayment.payAmtOne }元~0元
								    </c:when>
										<c:otherwise>  
								    	${orderSetupPayment.payAmtOne }元~${orderSetupPayment.payAmtTwo }元
								    </c:otherwise>
									</c:choose>
								</span>
							</p>
						...
						<form action="${ctx}/sendRecord/orderCenterRecord" method="post"
							id="formId">
							<input type="hidden" name="recordFlag" value="5">
						</form>


						<!--点击修改后-->
						<form id="setup_form"
							action="${ctx}/paymentCare/saveOrderSetupPaymentCare"
							method="post">
							<input type="hidden" value="${orderSetupPayment.id }" name="id" />
							<div class="position_absolute display_none change_2">
								<div class="clbo f_l h45 lh45 font14 m_l80 c_384856 m_t20">
									通知时间:</div>
								<div class="w_900 h45 f_l m_t18">
									<div class="wrap f_l h45 lh45 w140 m_l10 ">
										<div class="nice-select h45 lh45 nice-selectw"
											...
											<input readonly="readonly" id="startTime"
												...
												value="${orderSetupPayment.startTime }"
												style="color: #000000;">
											<ul>
												<li>00:00</li>
												<li>01:00</li>
									...
									<div class="wrap f_l h45 lh45 w140  ">
										<div class="nice-select h45 lh45 nice-selectw"
											...
											<input readonly="readonly" id="endTime"
												...
												value="${orderSetupPayment.endTime }"
												style="color: #000000;">
											<ul>
												<li>00:00</li>
												<li>01:00</li>
									...
									<div
										class="m_t14 w20 h20 bgc_e0e6ef b_radius5 f_l cursor_ GXK bgc_check_blue m_l40">
									</div>
									<div class="m_l10 f_l font14 c_8493a8 lh45 m_r10">超出时间不发送</div>
									<div id="timeMSG" class="col-md-6 lh45">
										<font></font>
									</div>
								</div>
								<div class="clbo f_l h45 lh45 font16 m_l80 c_384856 m_t20">
									实付金额:</div>
								<div class="w800 h45 f_l m_t18">
									<div class="f_l b_radius5 bgc_f4f6fa h45 w160 m_l10"
										style="width: 8.33333vw;">
										<input id="minPayment"
											class="b_radius5 bgc_f4f6fa w120 f_l border0 h45 lh45 p_l15 limit-1"
											name="payAmtOne" value="${orderSetupPayment.payAmtOne }"
									...
									<div class="f_l b_radius5 bgc_f4f6fa h45 w160"
										...
										<input id="maxPayment"
											...
											name="payAmtTwo" value="${orderSetupPayment.payAmtTwo }"
											placeholder="不限" onkeyup="value=value.replace(/[^\d.]/g,'')" />
									</div>
									<div class="m_l10 f_l font18 c_8493a8 lh45 m_l20">元</div>
									<div id="priceMSG" class="col-md-7 lh45"
										style="margin-left: 21.875vw;">
										<font></font>
									</div>
								</div>
					...
					<div class="w1590  bgc_fff c_384856 p_l50 font16 GaoJiSheZhi">
						<div class="w1030">
							...
							<div class="die_SZ m_b40 SaveG1">
								<div class="c_384856 h50 lh50 p_l30 font14">
									<div class="f_l m_r25 font14">地区筛选:</div>
									<div class="f_l DiQu font14">
										<c:choose>
											<c:when test="${orderAdvancedSettingPayment.locality==null }">
											默认全部

											</c:when>
											<c:when test="${orderAdvancedSettingPayment.locality=='0' }">
											   		 默认全部  
											    </c:when>
											<c:when
												test="${orderAdvancedSettingPayment.locality=='上海市,浙江省,江苏省' }">
											   		 江浙沪 
											    </c:when>
											<c:when
												test="${orderAdvancedSettingPayment.locality=='新疆维吾尔自治区,云南省,青海省,西藏自治区' }">
											   		偏远地区  
											    </c:when>
											<c:otherwise>  
											    	自定义
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									<div class="f_l m_r25 font14">卖家标记:</div>
									<div class="f_l font14">
										<c:if test="${orderAdvancedSettingPayment.vendormark==null }">
												所有卖家标记都不屏蔽
	                                        </c:if>
										<c:if test="${orderAdvancedSettingPayment.vendormark=='0' }">
												所有卖家标记都不屏蔽
	                                        </c:if>
										<c:if test="${orderAdvancedSettingPayment.vendormark=='1' }">
												屏蔽卖家标记
	                                        </c:if>
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									...
									<div class="f_l LaiYuan font14">
										<c:if test="${orderAdvancedSettingPayment.orderSource==null }">
												不限
	                                        </c:if>

										<c:if test="${orderAdvancedSettingPayment.orderSource=='0' }">
												不限
	                                        </c:if>
										<c:if test="${orderAdvancedSettingPayment.orderSource=='1' }">
												PC端
	                                        </c:if>
										<c:if test="${orderAdvancedSettingPayment.orderSource=='2' }">
												移动端
	                                        </c:if>
								...
								<!-- <div class="font14 c_384856 h50 lh50 p_l30">
									<div class="f_l m_r25 font14">会员等级:</div>
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									<div class="f_l m_r25 font14">商品选择:</div>
									<div class="font14 f_l AllShangPin">
										<c:if
											test="${orderAdvancedSettingPayment.productSelect==null }">
												全部商品
	                                        </c:if>
										<c:if
											test="${orderAdvancedSettingPayment.productSelect=='0' }">
												全部商品
	                                        </c:if>
										<c:if
											test="${orderAdvancedSettingPayment.productSelect=='1' }">
												指定商品
	                                        </c:if>
										<c:if
											test="${orderAdvancedSettingPayment.productSelect=='2' }">
												排除指定商品
	                                        </c:if>
									</div>
								</div>
							...
							<div class="display_none Live_SZ SaveG2">
								...
								<div class="f_r m_t150 p_l20">
									<div onclick="submitFormAdvanced('advanced_form')"
										class="w100 h45 lh45  b_radius5 bgc_00a0e9 c_fff text-center m_l10 f_l cursor_ SaveG">
										保存</div>
									<div
								...
								<form id="advanced_form"
									action="${ctx}/paymentCare/saveOrderAdvancedSettingPaymentCare"
									method="post">
									<input type="hidden" name="id"
										value="${orderAdvancedSettingPayment.id }" />
									<%-- 地区筛选 --详细地区--%>
									<input id="locality" type="hidden" name="locality"
										value="${orderAdvancedSettingPayment.locality }" />
									<%-- 地区筛选 --详细地区--%>
									<input id="vendormark" type="hidden" name="vendormark"
										value="${orderAdvancedSettingPayment.vendormark }" />
									<%-- 卖家标记--标识 --%>
									<input id="flagcolor" type="hidden" name="flagcolor"
										value="${orderAdvancedSettingPayment.flagcolor }" />
									<%-- 卖家标记--屏蔽的卖家标记小旗颜色 --%>
									<input id="orderSource" type="hidden" name="orderSource"
										value="${orderAdvancedSettingPayment.orderSource }" />
									<%-- 订单来源 --%>
									<input id="memberLevel" type="hidden" name="memberLevel"
										value="${orderAdvancedSettingPayment.memberLevel }" />
									<%-- 会员等级 --%>
									<input id="productSelect" type="hidden" name="productSelect"
										value="${orderAdvancedSettingPayment.productSelect }" />
									<%-- 商品选择--标识 --%>
									<input id="itemId" type="hidden" name="itemId"
										value="${orderAdvancedSettingPayment.itemId }" />
									<%-- 商品选择--商品id --%>
								</form>
							</div>
						...
						<div class="w1030 p_b40">
							...
							<div class="die_SZ SaveS1">
								...
								<div class="clear  h50 p_t40 w226  margin0_auto">
									<input type="button" id="addstatus" value="开启付款关怀"
									...
									<input id="buttonId" type="hidden"
										value="${orderSetupPayment.status }" /> <input
										id="orderSetupId" type="hidden"
										value="${orderSetupPayment.id }" />
								</div>
							</div>
							...
							<div class="Live_SZ display_none Live_SZ33 SaveS2">
								<form id="sms_form"
									action="${ctx}/paymentCare/saveOrUpdateSmsSetting"
									method="post">
									...
									<div class="font14 c_384856 h40 p_l30">
										...
										<%-- <div
											...
											class="w106 h40 lh40  b_radius5 bgc_00a0e9 c_fff text-center m_l10 f_r position_relative cursor_ ChaRuFuKuanLianJian">
											插入付款链接 <input type="hidden" name="paymentLink"
												value="${smsSetting.paymentLink }">
										</div> --%>
									...
									<div
										class="clear w226 h50 lh50  b_radius5 c_fff text-center margin0_auto m_t60 cursor_">
										开启付款关怀</div>
								</form>
							</div>
						</div>
					...
					<div
						...
						<textarea disabled="disabled"
							class="text_area_copy m_l45 m_t150 w250 h370 border0 bgc_fff">亲爱的卖家昵称，您已下单成功，付款前请勿相信不法分子冒充我司客服电话或旺旺QQ实施的行骗行为，有问题可联系客服哦~</textarea>
						<!--短信设置end-->
									...
									<div class="HuoDongWangZhi display_none">
										<div class="m_b10">
											...
											<input id="activityUrl"
												class="w500 h65 border0 bgc_f4f6fa b_radius8 f_l"
												type="text" value="">
										</div>
						...
						<!--引用短语库 end-->
						<!--立即开启-->
						<!--<div class="clbo h50 bgc_00a0e9 c_fff text-center b_radius5 margin150_auto l_h50 font16 cursor_ w226">
					 	开启付款关怀
					 </div>-->
					</div>
				</div>
...
// 		}
	...
	$(function() {
		var buttonId = $("#buttonId").val();
		if (buttonId == '0') {
			$("#addstatus").val("已开启付款关怀");
		}
		if (buttonId == '1') {

			$("#addstatus").val("已关闭付款关怀");
		}
	});
	//获取开启或关闭状态
	function addstatus() {
