	...
	<div class="w1903 h100_">
			...
			<div class="w1703 m_l200 p_b33">
				...
				<div class="w1660 m_t70 m_l30">
                    ...
                    <div class="w1620 bgc_f1f3f7 c_384856 p_l40" style="padding:0; width:86.4vw;">
                        <div class=" p_t27" style="padding-left:2.0833333vw;">
                        ...
                        <ul class="h40 font14 m_t38">
                            ...
                            <%-- <a href="${ctx}/sendRecord/cuifuRecord" class="c_384856" ><li class="f_l w140 text-center h40 l_h40 bgc_fff cursor_ ">发送记录</li></a> --%>
                    	...
                    	<div class="h103 lh103 w1280 p_l40 ">
                    	  <form id="formId" action="${ctx}/sendRecord/orderCenterRecord" method="post">
                        	<div class="font14 c_384856 h45 lh45">
								...
								<input name="recordFlag" value="2" type="hidden">  
