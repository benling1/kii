					...
					<div class="bgc_f1f3f7" style="width: 84.5vw;padding-left: 2vw;"> 
						<ul class="h40 p_t30 font14 ">
							...
							<a href="#" class="c_384856"  onclick="findOrderSendRedord('formId')"><li
						 	class="f_l w140 text-center h40 l_h40 bgc_fff cursor_ ">发送记录</li></a>
						</ul>
                    </div>
                    	...
                    	<div class="h103 lh103 w1280 p_l40 ">
                    	  <form id="formId" action="${ctx}/sendRecord/orderCenterRecord" method="post">
                        	<div class="font14 c_384856 h45 lh45">
								...
								<input name="recordFlag" value="7" type="hidden">
