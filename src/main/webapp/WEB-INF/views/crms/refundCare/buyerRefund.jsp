...
<body>
			...
			<div class="w1660 m_t70 m_l30">
				...
				<div class="w1660 bgc_f1f3f7 c_384856 ">
					<div class="p_l40 p_t30">
						<p class="font20" id="HEADER">买家申请退款</p>
						<div class="h40">
							<div
						...
						<div class="w1030">
							...
							<div class="change_1">
								<div class="w1000 font14 c_384856 h45 lh45 p_l30 m_b20">
									<div class="f_l m_r20 font14">通知时间:</div>
									<div class="font14 f_l m_r10 Time">${buyerRefund.startTime}</div>
									<div class="f_l m_r10">~</div>
									<div class="font14 f_l m_r25 Time2">${buyerRefund.endTime}</div>
								...
								<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
									...
									<div class="f_l Money">
										<c:if test="${buyerRefund.payAmtOne == 0}">不限</c:if>
										<c:if test="${buyerRefund.payAmtOne != 0}">${buyerRefund.payAmtOne}</c:if>

									</div>
									<div class="f_l m_r10">~</div>
									<div class="f_l Money">
										<c:if test="${buyerRefund.payAmtTwo==0}">不限</c:if>
										<c:if test="${buyerRefund.payAmtTwo !=0}">${buyerRefund.payAmtTwo}</c:if>
									</div>
								</div>
							</div>
							...
							<form action="${ctx}/basicSetup" method="post" id="formOne">
								<div class="display_none  change_2">
									<input name="id" type="hidden" value="${buyerRefund.id}" />
									<div class="w1000 font14 c_384856 h45 lh45 p_l30 m_b20">
											...
											<div class="wrap f_l h45 lh45 w140">
												<div class="nice-select h45 lh45 w117" name="nice-select">
													<input readonly="readonly" id="startTime"
														...
														value="${buyerRefund.startTime}" style="color: #000000;">
													<ul>
														<li>00:00</li>
														<li>01:00</li>
														<li>02:00</li>
											...
											<div class="wrap f_l h45 lh45 w140 m_l10">
												<div class="nice-select h45 lh45 w117" name="nice-select">
													<input readonly="readonly" id="endTime"
														...
														value="${buyerRefund.endTime }" style="color: #000000;">
													<ul>
														<li>00:00</li>
														<li>01:00</li>
														<li>02:00</li>
										...
										<div class=" f_l h45 lh45">
											...
											<div class="bgc_f4f6fa w140 f_l m_r10">
												<input id="maxPayment" placeholder="不限"
													...
													name="payAmtTwo"
													onkeyup="value=value.replace(/[^\d.]/g,'')"
													value="${buyerRefund.payAmtTwo}" />
												<div class="f_r w25">元</div>
											</div>
											<div id="priceMSG" class="col-md-7 lh45"
												style="margin-left: 18.2291667vw;">
												<font></font>
											</div>
									...
									<div class="clbo m_l860 w260">
										...
										<div onclick="submitFormOrderSetup('formOne')"
									...
									<!--   <div class="f_r m_t10 p_l20">
                                            <div onclick="submitFormOrderSetup('formOne')" class="w100 h45 lh45  b_radius5 bgc_00a0e9 c_fff text-center m_l10 f_l cursor_ save save_one">
                                                	保存
                                            </div>
						...
						<div class="w1030">
							...
							<div class="die_SZ m_b40 SaveG1">
								...
								<!-- <div class="font14 c_384856 h50 lh50 p_l30">
									...
									<div class="font14 f_l VipDengJi">
							...
							<div class="display_none Live_SZ SaveG2">
								...
								<form id="advanced_form" action="${ctx}/advancedSetting"
									...
									<input id="memberLevel" type="hidden" name="memberLevel"
										value="${orderAdvancedSetting.memberLevel }" />
									<%-- 会员等级 --%>
									...
									<input id="itemId" type="hidden" name="itemId"
										value="${orderAdvancedSetting.itemId }" />
									<%-- 商品选择--商品id --%>
								</form>
								<div style="clear: both"></div>
							</div>
						...
						<div class="w1030 p_b40">
							...
							<div class="die_SZ SaveS1">
								...
								<div class="clear  h50 p_t40 w226  margin0_auto">
									<input type="button" name="" id="addstatus" value="开启买家申请退款"
									...
									<input id="buttonId" type="hidden"
										value="${buyerRefund.status }" /> <input id="orderSetupId"
										type="hidden" value="${buyerRefund.id }" />
							...
							<div class="Live_SZ display_none SaveS2">
								<form id="smsSubmit" action="${ctx}/buyerRefundSmsSetting"
									method="post">
										...
										<div class="f_l m_r15">
											<ul style="margin-left: 1.3vw;">
												...
												<li
													style="font-size: 0.7vw;padding: 0.3vw 0.5vw;"
													class="b_radius5 bgc_00a0e9 c_fff text-center m_l10 f_l cursor_ position_relative ydh"
													onclick="addConsignee(document.getElementById('textContent'),'【订单链接】');">
													订单链接 <span
									...
									<input id="smsSettingId" name="id" type="hidden"
										...
										value="${smsSetting.mobileTest}"> <input
								...
								<div class="font14 c_384856 m_t30">
									...
									<%-- <div class="f_l w928 h285 bgc_f4f6fa radius10">
                                        <input id="textContent1" type="hidden" value="${smsSetting.messageContent}" name="messageContent" class="textContent1"/>
                                        <textarea id="textContent" name="content" maxlength="500" class="w888 h240 outline_none radius10 border0 bgc_f4f6fa p_l20 p_t15 p_r20 Letter11  text_area"></textarea>
                                        <textarea id="textContent" maxlength="500" class="w888 h240 outline_none radius10 border0 bgc_f4f6fa p_l20 p_t15 p_r20 Letter11  text_area" onkeyup="addLength()">${smsSetting.messageContent}</textarea>
                                        <div class="h30 m_l20 c_bfbfbf f_l">已输入:<span id="inputNum" class="text_count">0</span>字  当前计费：<span id="contenPrice">1</span>条</div>
                                        <div class="c_bfbfbf m_r15 f_r">退订回"
	                                        	<input maxlength="2" class="w20 h20 l_h20 border_0 bgc_f4f6fa" placeholder="N" id="refundMSG"/>"
	                                    </div>
                                        <div class="c_bfbfbf m_r15 f_r c_00a0e9">计费规则</div>
                                        <input type="text" id="actualDeduction_input" name="smsNumber" value="${smsSetting.smsNumber }"/>
                                    </div> --%>
								</div>
								...
								<div class="f_l w1030 font14 c_384856 h45 lh45 p_l30" style="margin-bottom: 1vw;">
									<div class="m_r10">
										...
										<input type="hidden" id="smsSign" name="messageSignature"
											value="${ShopName}" />
								...
								<div>
									<div
										class="position_absolute top_666 right240 iphone w327 h642"
										style="top: 43.6875vw;">
									...
									<img
										...
										src="${ctx}/crm/images/iPhone-gai.png" style="top: 43.6875vw;">
								</div>
								<div class="clear  h50 p_t40 w226  margin0_auto">
	...
	<input type='hidden' onclick='showval(this.value);' value="">
	<!--选择商品弹出框start-->
...
<script>
		...
		if (startTime == undefined || endTime == undefined) {
			...
			if (endTime != "" && startTime != "") {
				...
				if (endTimeFloat < startTimeFloat) {
					...
					$(timeMSG).html(
							"<font style='color: red;'>结束时间不能小于开始时间</font>");
					return false;
					...
					$(timeMSG).html(
							"<font style='color: red;'>结束时间不能等于开始时间</font>");
					return false;
				}
			}
		}
	...
	function submitFormOrderSetup(fomrId) {
		...
		var endTime = $("#endTime").val(); //获取基本设置结束时间
		var startTime = $("#startTime").val();//获取基本是指开始时间
		var maxPayment = $("#maxPayment").val();//获取基本设置实付金额
		var minPayment = $("#minPayment").val();//获取基本设置实付金额
		var maxPaymentFloat = parseFloat(maxPayment);
		var minPaymentFloat = parseFloat(minPayment);
	...
	function customRegion() {
		var regionName = "";
		var getprovince = $(".place_check").children().find('.li_').children(
				'.bgc_check_blue').next().children('input');
	...
	$(function() {
		var buttonId = $("#buttonId").val();
		if (buttonId == '0') {
			$("#addstatus").val("已开启买家申请退款");
		}
		if (buttonId == '1') {
			$("#addstatus").val("已关闭买家申请退款");
		}
	});
