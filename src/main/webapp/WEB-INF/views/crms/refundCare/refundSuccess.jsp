			...
			<div class="w1660 m_t70 m_l30">
				...
				<div class="w1660 bgc_f1f3f7 c_384856 ">
					<div class="p_l40 p_t30">
						<p class="font20" id="HEADER">退款成功</p>
						<div class="h40">
						...
						<div class="w1030">
							...
							<div class="change_1">
								<div class="w1000 font14 c_384856 h45 lh45 p_l30 m_b20">
									...
									<div class="f_l m_r10 Time">${rufundSeccess.startTime}</div>
									<div class="f_l m_r10">~</div>
									<div class="f_l m_r25 Time2">${rufundSeccess.endTime}</div>
								...
								<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
									...
									<div class="font14 f_l Money">
										<c:if test="${rufundSeccess.payAmtOne==0} ">不限</c:if>
										<c:if test="${rufundSeccess.payAmtOne!=0}">${rufundSeccess.payAmtOne} </c:if>
									</div>
									<div class="f_l m_r10">~</div>
									<div class="f_l Money">
										<c:if test="${rufundSeccess.payAmtTwo == 0}">不限</c:if>
										<c:if test="${rufundSeccess.payAmtTwo !=0}">${rufundSeccess.payAmtTwo}</c:if>
									</div>
								</div>
							</div>
							...
							<form action="${ctx}/refundSuccess" method="post" id="formOne">
								<div class="display_none  change_2">
									<input name="id" value="${rufundSeccess.id}" type="hidden" />
									<div class="w1000 font14 c_384856 h45 lh45 p_l30 m_b20">
											...
											<div class="wrap f_l h45 lh45 w140">
												<div class="nice-select h45 lh45 w117" name="nice-select">
													<input readonly="readonly" id="startTime"
														...
														style="color: #000000;" value="${rufundSeccess.startTime}"
														style="color: #000000;">
													<ul>
														<li>00:00</li>
														<li>01:00</li>
											...
											<div class="wrap f_l h45 lh45 w140 m_l10">
												<div class="nice-select h45 lh45 w117" name="nice-select">
													<input readonly="readonly" id="endTime"
														...
														value="${rufundSeccess.endTime }" style="color: #000000;">
													<ul>
														<li>00:00</li>
														<li>01:00</li>
														<li>02:00</li>
									...
									<div class="f_r m_t10 p_l20">
										<div onclick="refundSuccess('formOne')"
							...
							<div class="die_SZ m_b40 SaveG1">
								<div class="font14 c_384856 h50 lh50 p_l30">
									...
									<div class="font14 f_l DiQu">
										<c:choose>
											<c:when test="${firstclass.locality==null }">
 默认全部  
											    </c:when>
											<c:when test="${firstclass.locality=='0' }">
											   		 默认全部  
											    </c:when>
											<c:when test="${firstclass.locality=='上海市,浙江省,江苏省' }">
											   		 江浙沪 
											    </c:when>
											<c:when
												test="${firstclass.locality=='新疆维吾尔自治区,云南省,青海省,西藏自治区' }">
											   		偏远地区  
											    </c:when>
											<c:otherwise>  
											    	自定义
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									...
									<div class="f_l">
										<c:if test="${firstclass.vendormark==null }">
												所有卖家标记都不屏蔽
	                                        </c:if>
										<c:if test="${firstclass.vendormark=='0' }">
												所有卖家标记都不屏蔽
	                                        </c:if>
										<c:if test="${firstclass.vendormark=='1' }">
												屏蔽卖家标记
	                                        </c:if>
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									...
									<div class="font14 f_l LaiYuan">
										<c:if test="${firstclass.orderSource==null }">
												不限
	                                        </c:if>

										<c:if test="${firstclass.orderSource=='0' }">
												不限
	                                        </c:if>
										<c:if test="${firstclass.orderSource=='1' }">
												PC端
	                                        </c:if>
										<c:if test="${firstclass.orderSource=='2' }">
												移动端
	                                        </c:if>
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									...
									<div class="font14 f_l AllShangPin">
										<c:if test="${firstclass.productSelect==null }">
												全部商品
	                                        </c:if>
										<c:if test="${firstclass.productSelect=='0' }">
												全部商品
	                                        </c:if>
										<c:if test="${firstclass.productSelect=='1' }">
												指定商品
	                                        </c:if>
										<c:if test="${firstclass.productSelect=='2' }">
												排除指定商品
	                                        </c:if>
									</div>
								</div>
							...
							<div class="display_none Live_SZ SaveG2">
								...
								<div class="f_r m_t150 p_l20">
									<div onclick="submitFormAdvanced('advanced_form1')"
						...
						<div class="w1030 p_b40">
							...
							<div class="die_SZ SaveS1">
								...
								<div class="clear  h50 p_t40 w226  margin0_auto">
									<!-- <input type="button" name="" id="addstatus" value="开启退款成功" class="w226 h50 lh50  b_radius5 bgc_00a0e9 c_fff text-center margin0_auto cursor_ font16 lijikaiqi_1 border0"/>  -->
									<input type="button" name="" id="addstatus" value="开启退款成功"
										class="w226 h50 lh50  b_radius5 bgc_00a0e9 c_fff text-center margin0_auto cursor_ font16 lijikaiqi__1 border0" />
									<input id="buttonId" type="hidden"
										value="${rufundSeccess.status }" /> <input id="orderSetupId"
										type="hidden" value="${rufundSeccess.id }" />
							...
							<div class="Live_SZ display_none SaveS2">
								<form action="${ctx}/refuendSuccessSmsSetting" id="smsSubmit"
									method="post">
								...
								<div class="font14 c_384856 m_t30">
									...
									<div class="f_l w_900 h285 bgc_f4f6fa radius10">
										...
										<textarea onkeyup="addLength();" id="textContent"
											name="content"
											class="w860 h240 outline_none radius10 border0 bgc_f4f6fa p_l20 p_t15 Letter11  text_area"></textarea>
...
// 						}
	...
	//开启关闭设置数据
		...
		$(function(){
			var buttonId = $("#buttonId").val();
			if(buttonId == '0'){
				$("#addstatus").val("已开启退款成功");
			}
			if(buttonId == '1'){
				$("#addstatus").val("已关闭退款成功");
			}
		});
