...
<script src="${ctx}/crm/js/tuikuanguanhuai.js" type="text/javascript"
		...
		<div class="w1703 m_l200 p_b33">
			...
			<div class="w1660 m_t70 m_l30">
				...
				<div class="w1660 bgc_f1f3f7 c_384856 ">
					<div class="p_l40 p_t30">
						<p class="font20" id="HEADER">拒绝退款</p>
						<div class="h40">
							<div
					...
					<ul class="h40 p_t30 font14 p_l40">
						<li class="f_l w140 text-center h40 l_h40 bgc_e3e7f0 cursor_"><a
							href="${ctx}/crms/refundCare/buyerRefund"
							class="display_block c_384856">买家申请退款</a></li>
						<li class="f_l w140 text-center h40 l_h40 bgc_e3e7f0 cursor_"><a
							href="${ctx}/crms/refundCare/refundSuccess"
							class="display_block c_384856">退款成功</a></li>
						<li class="f_l w140 text-center h40 l_h40 bgc_e3e7f0 cursor_"><a
							href="${ctx}/crms/refundCare/waitingRefund"
							class="display_block c_384856">等待退货</a></li>
						<li class="f_l w140 text-center h40 l_h40 bgc_fff  cursor_"><a
							href="${ctx}/crms/refundCare/refusedRefund"
							class="display_block c_384856">拒绝退款</a></li>
						<a href="#" class="c_384856"  onclick="findOrderSendRedord('formId')"><li
				...
				<div class="w1660 bgc_fff TABLE2 tui1">
					<div class="w1590  c_384856 p_l50 font16 p_t40">
						<div class="w1030">
							<div class="h47">
								<p>
									基本设置<span class="font14 c_00a0e9 p_l10 cursor_  change">修改</span>
								</p>
							</div>
							<div class="change_1">
								<div class="w1000 font14 c_384856 h45 lh45 p_l30 m_b20">
									<div class="font14 f_l m_r20">通知时间:</div>
									<div class="f_l m_r10 Time">${refusedRefund.startTime}</div>
									<div class="f_l m_r10">~</div>
									<div class="f_l m_r25 Time2">${refusedRefund.endTime}</div>
									<div class="font14 f_l">超出时间次日通知</div>
								</div>

								<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
									<div class="font14 f_l m_r20">实付金额:</div>
									<div class="font14 f_l Money">
										<c:if test="${refusedRefund.payAmtOne == 0}">不限</c:if>
										<c:if test="${refusedRefund.payAmtOne !=0}">${refusedRefund.payAmtOne}</c:if>
									</div>
									<div class="f_l m_r10">~</div>
									<div class="font14 f_l Money">
										<c:if test="${refusedRefund.payAmtTwo == 0}">不限</c:if>
										<c:if test="${refusedRefund.payAmtTwo !=0}">${refusedRefund.payAmtTwo}</c:if>
									</div>
								</div>
							</div>
							<form action="${ctx}/sendRecord/orderCenterRecord" method="post" id="formId">
								<input type="hidden" name="recordFlag" value="7">
							</form>
							<form action="${ctx}/refusedRefund" method="post" id="formOne">
								<div class="display_none  change_2">
									<input name="id" value="${refusedRefund.id}" type="hidden" />
									<div class="w1000 font14 c_384856 h45 lh45 p_l30 m_b20">
										<div class="font14 f_l m_r15">通知时间:</div>
											...
											<div class="wrap f_l h45 lh45 w140">
												<div class="nice-select h45 lh45 w117" name="nice-select">
													<input readonly="readonly" id="startTime"
														class="h45 lh45 w140 Time11" type="text" name="startTime"
														style="color: #000000;" value="${refusedRefund.startTime}">
													<ul>
														<li>00:00</li>
														<li>01:00</li>
														<li>02:00</li>
											...
											<div class="wrap f_l h45 lh45 w140 m_l10">
												<div class="nice-select h45 lh45 w117" name="nice-select">
													<input readonly="readonly" id="endTime"
														class="h45 lh45 w140 Time22" type="text" name="endTime"
														value="${refusedRefund.endTime }" style="color: #000000;">
													<ul>
														<li>00:00</li>
														<li>01:00</li>
														<li>02:00</li>
										...
										<div class="f_l row">
											<div class="font14 m_l10 f_l font14 c_8493a8 lh45 col-lg-4"
												style="margin-right: 5px;">超出设置时间段，自动顺延至次日发送</div>
											<div id="timeMSG" class="col-md-6 lh45 f_l">
												<font></font>
											</div>
										</div>
									...
									<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
										<div class="font14 f_l m_r15">实付金额:</div>
										<div class=" f_l h45 lh45">
											<div class="bgc_f4f6fa w140 f_l m_r10 radius10">
												<input id="minPayment" placeholder="不限"
													class="f_l bgc_f4f6fa border0 w85 h45 lh45 p_l15 outline_none Money11"
													name="payAmtOne"
													onkeyup="value=value.replace(/[^\d.]/g,'')"
													value="${refusedRefund.payAmtOne}" />
												<div class="font14 f_r w25">元</div>
											</div>
											<div class="f_l m_r10">~</div>
											<div class="font14 bgc_f4f6fa w140 f_l m_r10">
												<input id="maxPayment" placeholder="不限"
													class="f_l bgc_f4f6fa border0 w85 h45 lh45 p_l15 outline_none Money22"
													name="payAmtTwo"
													onkeyup="value=value.replace(/[^\d.]/g,'')"
													value="${refusedRefund.payAmtTwo}" />
												<div class="font14 f_r w25">元</div>
											</div>
											<div id="priceMSG" class="col-md-7 lh45 f_l">
												<font></font>
											</div>
										</div>
									</div>
									<div class="font14 c_384856 h45 lh45 p_l30 m_t10">
										<div class="font14 f_l m_r15">过滤条件:</div>
										<div class="f_l m_l10">
											<div
												class="m_t10 w20 h20 bgc_e0e6ef b_radius5 f_l bgc_check_blue">
											</div>
											<div class="font14 m_l10 f_l font14 c_384856 lh40">
												同一买家，一天只发送一次</div>
										</div>
									...
									<div class="font14 f_r m_t10 p_l20">
										<div onclick="refusedrefund('formOne')"
											class="w100 h45 lh45  b_radius5 bgc_00a0e9 c_fff text-center m_l10 f_l cursor_ save save_one">
											保存</div>
										<div
					...
					<div class="w1590  bgc_fff c_384856 p_l50 font16 GaoJiSheZhi">
						<div class="w1030">
							...
							<div class="die_SZ m_b40 SaveG1">
								<div class="font14 c_384856 h50 lh50 p_l30">
									<div class="font14 f_l m_r25">地区筛选:</div>
									<div class="font14 f_l DiQu">
										<c:choose>
											<c:when test="${refusedRefundGj.locality==null }">
	                                        	 默认全部 
											    </c:when>
											<c:when test="${refusedRefundGj.locality=='0' }">
											   		 默认全部  
											    </c:when>
											<c:when test="${refusedRefundGj.locality=='上海市,浙江省,江苏省' }">
											   		 江浙沪 
											    </c:when>
											<c:when
												test="${refusedRefundGj.locality=='新疆维吾尔自治区,云南省,青海省,西藏自治区' }">
											   		偏远地区  
											    </c:when>
											<c:otherwise>  
											    	自定义
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									<div class="font14 f_l m_r25">卖家标记:</div>
									<div class="font14 f_l">
										<c:if test="${refusedRefundGj.vendormark==null }">
												所有卖家标记都不屏蔽
	                                        </c:if>
										<c:if test="${refusedRefundGj.vendormark=='0' }">
												所有卖家标记都不屏蔽
	                                        </c:if>
										<c:if test="${refusedRefundGj.vendormark=='1' }">
												屏蔽卖家标记
	                                        </c:if>
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									<div class="font14 f_l m_r25">订单来源:</div>
									<div class="font14 f_l LaiYuan">
										<c:if test="${refusedRefundGj.orderSource==null }">
												不限
	                                        </c:if>

										<c:if test="${refusedRefundGj.orderSource=='0' }">
												不限
	                                        </c:if>
										<c:if test="${refusedRefundGj.orderSource=='1' }">
												PC端
	                                        </c:if>
										<c:if test="${refusedRefundGj.orderSource=='2' }">
												移动端
	                                        </c:if>
								...
								<!-- <div class="font14 c_384856 h50 lh50 p_l30">
									<div class="font14 f_l m_r25">会员等级:</div>
									<div class="f_l VipDengJi">
										<span id="memberLevelId" class="font14">不限</span>
									</div>
								</div> -->
								...
								<div class="font14 c_384856 h50 lh50 p_l30">
									...
									<div class="font14 f_l AllShangPin">
										<c:if test="${refusedRefundGj.productSelect==null }">
												全部商品
	                                        </c:if>
										<c:if test="${refusedRefundGj.productSelect=='0' }">
												全部商品
	                                        </c:if>
										<c:if test="${refusedRefundGj.productSelect=='1' }">
												指定商品
	                                        </c:if>
										<c:if test="${refusedRefundGj.productSelect=='2' }">
												排除指定商品
	                                        </c:if>
									</div>
								</div>
							...
							<!----------------------------------------------     高级设置编辑部分           ----------------------------------------------------->
							<div class="display_none Live_SZ SaveG2">
								<div class="font14 c_384856 h50 lh50 p_l30 DiQuShaiXuan">
									...
									<div class="f_l m_l10">
										<div id="dq1" onclick="addRegionflag(1);"
											...
											<span
												class="position_absolute w200 l_h22 left_70 top_32 c_384856 bgc_f4f6fa text-center display_none z_20 font14">江苏省，浙江省，上海</span>
										</div>
									...
									<div class="f_l m_l10">
										<div id="dq2" onclick="addRegionflag(2);"
											class="m_t10 w20 h20 bgc_e0e6ef b_radius5 f_l cursor_ GXK m_t17 JiangZheHu position_relative">
											<span
												class="position_absolute w200 l_h22 left_70 top_32 c_384856 bgc_f4f6fa text-center display_none z_20 font14">新疆、西藏、云南省、青海省</span>
										</div>
								...
								<div class="f_r m_t150 p_l20">
									<div onclick="submitFormAdvanced('advanced_form')"
										...
										保存</div>
									<div
										class="w100 h43 lh45 b_radius5 bor_cad3df c_cad3df text-center m_l10 f_l cursor_ CanceG">
										取消</div>
								</div>
								<!-- 保存按钮点击提交form表单 -->
								<form id="advanced_form" action="${ctx}/refusedRefundGj"
									method="post">
									<input type="hidden" name="id" value="${refusedRefundGj.id }" />
									<%-- 地区筛选 --详细地区--%>
									<input id="locality" type="hidden" name="locality"
										value="${refusedRefundGj.locality }" />
									<%-- 地区筛选 --详细地区--%>
									<input id="vendormark" type="hidden" name="vendormark"
										value="${refusedRefundGj.vendormark }" />
									<%-- 卖家标记--标识 --%>
									<input id="flagcolor" type="hidden" name="flagcolor"
										value="${refusedRefundGj.flagcolor }" />
									<%-- 卖家标记--屏蔽的卖家标记小旗颜色 --%>
									<input id="orderSource" type="hidden" name="orderSource"
										value="${refusedRefundGj.orderSource }" />
									<%-- 订单来源 --%>
									<input id="memberLevel" type="hidden" name="memberLevel"
										value="${refusedRefundGj.memberLevel }" />
									<%-- 会员等级 --%>
									<input id="productSelect" type="hidden" name="productSelect"
										value="${refusedRefundGj.productSelect }" />
									<%-- 商品选择--标识 --%>
									<input id="itemId" type="hidden" name="itemId"
										value="${refusedRefundGj.itemId }" />
									<%-- 商品选择--商品id --%>
								</form>
								<div style="clear: both"></div>
							</div>
					...
					<%--  <form action="${ctx}/advancedSetting" id="formBuyer_Gj" method="post">
                        <input type="text" name="id" value="${orderAdvancedSetting.id }"/>
                       	<input id="locality" type="text" name="locality" value="${orderAdvancedSettingXDGH.locality }" />地区筛选 --详细地区
                       	<input id="vendormark" type="text" name="vendormark" value="${orderAdvancedSetting.vendormark }"/>卖家标记--标识
                       	<input id="flagcolor" type="text" name="flagcolor" value="${orderAdvancedSetting.flagcolor }"/>卖家标记--屏蔽的卖家标记小旗颜色	
                       	<input id="orderSource" type="text" name="orderSource" value="${orderAdvancedSetting.orderSource}"/>订单来源
                       	<input id="memberLevel" type="text" name="memberLevel" value="${orderAdvancedSetting.memberLevel }"/>会员等级
                       	<input id="productSelect" type="text" name="productSelect" value="${orderAdvancedSetting.productSelect }"/>商品选择--标识
                       	<input id="itemId" type="text" name="itemId" value="${orderAdvancedSetting.itemId }"/>商品选择--商品id
						...
						<div class="w1030 p_b40">
							...
							<div class="die_SZ SaveS1">
								...
								<div class="clear  h50 p_t40 w226  margin0_auto">
									<!-- <input type="button" name="" id="addstatus" value="开启拒绝退款，等待买家修改" class="w226 h50 lh50  b_radius5 bgc_00a0e9 c_fff text-center margin0_auto cursor_ font16 lijikaiqi border0"/> -->
									<input type="button" name="" id="addstatus"
										value="开启拒绝退款，等待买家修改"
										class="w226 h50 lh50  b_radius5 bgc_00a0e9 c_fff text-center margin0_auto cursor_ font16 lijikaiqi__4 border0" />
									<input id="buttonId" type="hidden"
										value="${refusedRefund.status }" /> <input id="orderSetupId"
										type="hidden" value="${refusedRefund.id }" />
									<!-- <div class="w226 h50 lh50  b_radius5 bgc_00a0e9 c_fff text-center margin0_auto cursor_">开启买家申请退款</div>-->
								</div>
							</div>


							<!------------------------------    短信设置编辑部分        -------------------------------------->
							<div class="Live_SZ display_none SaveS2">
								<form id="smsSubmit" action="${ctx}/saverefusedRefundSmsSetting"
									method="post">
									...
									<input id="smsSettingId" name="id" type="hidden"
										value="${smsSetting.id}"> <input id="smsContent"
										type="hidden" name="messageContent"> <input
										id="smsSign" name="messageSignature" type="hidden"> <input
										id="testPhoneForm" type="hidden" name="mobileTest">
								</form>
								...
								<div class="font14 c_384856 m_t30">
									...
									<div class="f_l w_900 h285 bgc_f4f6fa radius10">
										<input type="hidden" class="textContent1" id="textContent1"
											name="messageContent" value="${smsSetting.messageContent}">
										<textarea onkeyup="addLength();" id="textContent"
											name="content"
											class="w860 h240 outline_none radius10 border0 bgc_f4f6fa p_t15 p_r20 Letter11  text_area"></textarea>
								...
								<div class="f_l w1030 font14 c_384856 h45 lh45 p_l30" style="margin-bottom: 1vw;">
									<div class="m_r10">
										短信签名: <input style="width: 10vw;"
											...
											onclick="updateDisabled();"><input
											type="hidden" id="smsSign" name="messageSignature"
											value="${ShopName}" />
								...
								<div class="f_l w1030 font14 c_384856 h45 lh45 p_l30">
									<div class="m_r10">
										测试手机: <input id="testPhone" value="${smsSetting.mobileTest}"
											...
											class="m_l10 c_00a0e9 m_l20 refusedRefund ceShiFaSong1 cursor_">测试发送</a>
									</div>
								...
								<div class="clear  h50 p_t40 w226  margin0_auto">
									<!-- <input type="button" name="" id="" value="开启退款成功"
										class="w226 h50 lh50  b_radius5 bgc_00a0e9 c_fff text-center margin0_auto cursor_ font16 lijikaiqi_1 border0" /> -->
									<!-- <div class="w226 h50 lh50  b_radius5 bgc_00a0e9 c_fff text-center margin0_auto cursor_">开启买家申请退款</div>-->
								</div>
							</div>
						</div>
					...
					<div
						...
						style="top: 45.833333vw;">
						<img
							class="iphone_lianjie position_absolute  ShouHuoTu z_2 display_none"
							src="${ctx}/crm/images/shouhuotu.jpg">
				...
				<form class="font14" action="#">
					<p class="f_l">
						商品ID:<input id="itemId_input"
							...
							type="text" style="width: 13.270833vw;" />
					</p>
					<p class="f_l">
						关键字:<input id="itemName_input"
							class="h50 w260 border0 outline_none b_radius5 m_l15 m_r18 bgc_f4f6fa"
							type="text" />
					</p>
					<p class="f_l">
						<!-- <span class="cursor_ one_check_only w20 h20 bgc_e0e6ef b_radius5 m_t13 f_l">
                                                        ...
                                                        <span class="m_l10">
                                                            只显示上架 <input onclick="findItemByData();" class="h40 w80 border0 outline_none b_radius5 m_l35 bgc_00a0e9 c_fff "  type="button" value="搜索"/>
                                                        </span> -->
					<div id="putaway_div"
		...
		<div class="w630  p_b40 bgc_fff m_t100 m_l500" style="height: 30vw;">
			...
			<form action="#" class="p_l24  p_r20 TaoBaoLianJie2">
				...
				<div>
					...
					<div class="f_r m_r15">
						<a
							href="https://crm.bbs.taobao.com/detail.html?spm=a210m.7802402.0.0.zeU4Ci_a210m.7802402.0.0.lk6D3P_a210m.7802402.0.0.Dd9Nw4&postId=1622316" target="_blank">
...
// 						}
	...
	//-------------------------------------短信设置----------------------------------------------
	  //保存或更新短信设置
		...
		$("#textContent1").val(contentVal);
		if(length>70){
			$("#actualDeduction_input").val(Math.ceil(length/67));
			document.getElementById("contenPrice").innerText=Math.ceil(length/67);			
		}else if(length<70){
			$("#actualDeduction_input").val(Math.ceil(length/67));
			document.getElementById("contenPrice").innerText=Math.ceil(length/67);
		}
		...
		function saveTemplate(){
			...
			$.ajax({
				url:"${ctx}/saveRefundCareSmsTemplate",
				type:"post",
		...
		/* $(document).on("click", ".Template_div", function () {
			...
			if(content.length>70){
				document.getElementById("contePrice").innerText=Math.ceil(content.length/67);			
			}
		}); */
		...
		//开启关闭设置数据
			$(function(){
					$("#addstatus").click(function(){
						...
						if(buttonId == '0'){
							$("#buttonId").val('1');
							//$("#addstatus").val("开启拒绝退款，等待买家修改");
						}else if(buttonId == '1'){
							$("#buttonId").val('0');
							//$("#addstatus").val("关闭拒绝退款，等待买家修改");
						}
						addstatus();
					});
				});
			...
			$(function(){
					var buttonId = $("#buttonId").val();
					if(buttonId == '0'){
						$("#addstatus").val("已开启拒绝退款，等待买家修改");
					}
					if(buttonId == '1'){
						$("#addstatus").val("已关闭拒绝退款，等待买家修改");
					}
			});
