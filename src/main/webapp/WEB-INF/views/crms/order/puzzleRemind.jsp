...
<script type="text/javascript" src="${ctx}/crm/js/yinanjiantixing.js"></script>
			...
			<div class="w1660 m_t70 m_l30">
				...
				<div class="w1660 bgc_f1f3f7 c_384856 ">
					<div class="p_l40 p_t27">
						<p class="font20" id="HEADER">疑难件提醒</p>
					...
					<ul class="h40 font14 m_t1_7 p_l40">
						...
						<a href="${ctx}/puzzleRemind/queryPuzzleRemind" class="c_384856"><li
							class="f_l w140 text-center h40 l_h40 bgc_fff cursor_ ">疑难件提醒</li></a>
					...
					<div class="w750 p_b33 bgc_fff m_t100 m_l500 fasf">
						...
						<div class="h40 margin0_auto w225">
							<div onclick="customRegion();"
								class="w100 h45 lh45  b_radius5 bgc_00a0e9 c_fff text-center m_l10 f_l close_1">
								保存</div>
							<div
								class="w100 h43 lh45 b_radius5 bor_cad3df c_cad3df text-center m_l10 f_l close_1">
								取消</div>
						</div>
						...
						<div class="w1030">
							...
							<div class="die_SZ">
								<div class="font14 c_384856 h45 lh45 p_l30">
									...
									<div class="f_l m_l14 Money">
										<c:choose>
											<c:when
												test="${orderSetup.payAmtOne==null && orderSetup.payAmtTwo==null }">
														不限
											    </c:when>
											<c:when test="${orderSetup.payAmtOne==null}">
														0元~${orderSetup.payAmtTwo }元
											    </c:when>
											<c:when test="${orderSetup.payAmtTwo==null}">
														${orderSetup.payAmtOne }元~0元
											    </c:when>
											<c:otherwise>  
											    	${orderSetup.payAmtOne }元~${orderSetup.payAmtTwo }元
											    </c:otherwise>
										</c:choose>
									</div>
								</div>
								<div class="font14 c_384856 h45 lh45 p_l30">
									<div class="f_l m_r50">超时未签收:</div>
									<div class="f_l">
										<span>发货超过</span><span class="TIMEW1">${orderSetup.notSignInTimeout }</span><span>未签收</span>
									</div>
								</div>
								<div class="font14 c_384856 h45 lh45 p_l30 m_b50">
									<div class="f_l m_r50">超时无更新:</div>
									<div class="f_l ">
										<span>在超过</span><span class="TIMEX1">${orderSetup.notUpdateTiemout }</span><span>物流信息未变化</span>
							...
							<div class="display_none Live_SZ">
								<form id="setup_form"
									action="${ctx}/puzzleRemind/saveOrUpdateOrderSetup"
									method="post">
									<input type="hidden" value="${orderSetup.id }" name="id" />
									<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
										<div class="f_l m_r30">通知时间:</div>
										<div class="f_l">默认每天 9:00--21:00
											期间，满足条件立即发送短信，超出设置时间段，自动顺延至次日发送。</div>
									</div>
									<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
										<div class="f_l m_r30">实付金额:</div>
										<div class=" f_l h45 lh45">
											<div class="bgc_f4f6fa w140 f_l m_r10 radius10">
												<input id="minPayment"
													...
													name="payAmtOne" value="${orderSetup.payAmtOne }"
													placeholder="不限" />
											...
											<div class="bgc_f4f6fa w140 f_l m_r10">
												<input id="maxPayment"
													...
													name="payAmtTwo" value="${orderSetup.payAmtTwo }"
													placeholder="不限" />
												<div class="f_r w25">元</div>
											</div>
										</div>
									...
									<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
										...
										<div class="wrap f_l h45 lh45 m_r15">
											...
											<div class="f_l">未签收</div>
										</div>
									</div>
									<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
										<div class="f_l m_r15">超时无更新:</div>
										<div class="wrap f_l h45 lh45 m_r15">
											<div class="f_l m_r5">在途超过</div>
											<div class="wrap f_l h45 lh45 w140">
												<div class="nice-select h45 lh45 w117 z_2"
													name="nice-select">
													<input readonly="readonly" class="h45 lh45 w140 TIMEX"
														style="color: #000;" type="text" name="notUpdateTiemout"
														value="${orderSetup.notUpdateTiemout }">
													<ul>
														<li>1天</li>
														<li>2天</li>
														<li>3天</li>
											...
											<div class="f_l">物流信息</div>
										</div>
									</div>
									<div class="font14 c_384856 h45 lh45 p_l30 m_t10">
										<div class="f_l m_r15">默认条件:</div>
										<div class="f_l m_l10">
											<div
												class="m_t10 w20 h20 bgc_e0e6ef b_radius5 f_l cursor_ bgc_check_blue">
											</div>
											<div class="m_l10 f_l font14 c_384856 lh40">
												疑难件：物流信息包含“疑难”、“疑难件”等信息。</div>
										</div>
										<div class="f_l m_l10">
											<div
												class="m_t10 w20 h20 bgc_e0e6ef b_radius5 f_l cursor_ bgc_check_blue">
									...
									<div class="f_r m_t10 p_l20">
										<div onclick="submitFormOrderSetup('setup_form')"
											...
											保存</div>
										<div
											class="w100 h43 lh45 b_radius5 bor_cad3df c_cad3df text-center m_l10 f_l cursor_ Cancel1">
											取消</div>
									</div>
						...
						<div class="w1030">
							...
							<div class="display_none Live_SZ">
								...
								<div class="font14 c_384856 h50 lh50 p_l30 DiQuShaiXuan">
									<div class="f_l m_r15">
										地区筛选:
										<!-- <input id="region_filtrate" type="hidden" name="" value="0" /> -->
								...
								<form id="advanced_form"
									action="${ctx}/puzzleRemind/saveOrderAdvancedSetting"
									method="post">
					...
					<div class="w1590  bgc_fff c_384856 p_l50 font16 DuanXinSheZhi">
						<div class="w1030 p_b40">
							...
							<div class="die_SZ duanxinshezhibukebianji">
								...
								<div class="clear w1030 h50 p_t40">
									<div
										...
										<input type="button" name="" id="addstatus" value="开启疑难件提醒"
							...
							<div class="Live_SZ min_h570 DXSZBianJiBuFen display_none">
								<form id="sms_form"
									action="${ctx}/puzzleRemind/saveOrUpdateSmsSetting"
									method="post">
									...
									<div class="font14 c_384856 m_t30">
										...
										<div class="f_l w928 h285 bgc_f4f6fa radius10">
											<%-- <input id="textContent1" type="hidden"  value="${smsSetting.messageContent}"  name="messageContent"/>  --%>
...
<%--                                 ${ShopName}亲，我们的交易已经成功，希望您能确认+好评，我们才有充裕的资金流转，来提高店铺质量和服务，祝您生活愉快！ --%>
						...
						<img
							class="w327 h642 position_absolute display_none ShouHuoTu z_2 right240 top690"
...
<script>
	...
	$(function() {
		var buttonId = $("#buttonId").val();
		if (buttonId == '0') {
			$("#addstatus").val("已开启疑难件提醒");
		}
		if (buttonId == '1') {
			$("#addstatus").val("已关闭疑难件提醒");
		}
	});
	//获取开启或关闭状态
	function addstatus() {
