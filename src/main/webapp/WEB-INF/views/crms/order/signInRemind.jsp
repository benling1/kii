...
<script type="text/javascript" src="${ctx}/crm/js/qianshoutixing.js"></script>
			...
			<div class="w1660 m_t70 m_l30">
				...
				<div class="w1660  bgc_f1f3f7 c_384856 ">
					<div class="p_l40 p_t27">
						<p class="font20" id="HEADER">签收提醒</p>
					...
					<ul class="p_l40 h40 font14 m_t1_7">
						...
						<a href="${ctx}/signInRemind/querySignInRemind" class="c_384856"><li
							class="f_l w140 text-center h40 l_h40 bgc_fff cursor_">签收提醒</li></a>
						...
						<a href="#"
							class="c_384856" onclick="findOrderSendRedord('formId')"><li
				...
				<div class="w1660 bgc_fff">
					...
					<div class="w1590 c_384856 p_l50 font16 p_t40">
						<div class="w1030">
							...
							<div class="display_none Live_SZ">
								<form id="setup_form"
									action="${ctx}/signInRemind/saveOrUpdateOrderSetup"
									method="post">
									...
									<div class="font14 c_384856 h45 lh45 p_l30 m_b20">
										...
										<div class="f_l">默认每天9:00--21:00期间，到达同城立即发送短信，超出时间次日发送。</div>
									</div>
					...
					<div
						class="w1590  bgc_fff c_384856 p_l50 font16 GaoJiSheZhi GaoJiSheZhi">
						<div class="w1030">
							<div class="h47">
								<p>
							...
							<div class="display_none Live_SZ">
								...
								<div class="clear font14 c_384856 h50 lh50 p_l30">
									<div class="f_l m_r15">
								...
								<form id="advanced_form"
									action="${ctx}/signInRemind/saveOrderAdvancedSetting"
									method="post">
					...
					<div class="w1590  bgc_fff c_384856 p_l50 font16 DuanXinSheZhi">
						<div class="w1030 p_b40">
							...
							<div class="die_SZ duanxinshezhibukebianji">
								...
								<div class="clear w1030 h50 p_t40">
									<div
										...
										<input type="button" name="" id="addstatus" value="开启签收提醒"
							...
							<div class="Live_SZ min_h570 DXSZBianJiBuFen display_none">
								<form id="sms_form"
									action="${ctx}/signInRemind/saveOrUpdateSmsSetting"
									method="post">
									...
									<div class="font14 c_384856 m_t30">
										...
										<div class="f_l w928 h285 bgc_f4f6fa radius10">
											<input type="hidden" id="textContent1" 
												...
												type="hidden" id="settingType" name="settingType" value="9">
											<textarea id="textContent" name="messageContent"
												class="w888 h240 outline_none radius10 border0 bgc_f4f6fa p_l20 p_t15 p_r20 Letter11  text_area"></textarea>
									...
									<div class="f_r m_t50">
										<div onclick="submitSmsForm('sms_form')"
											class="w100 h45 lh45  b_radius5 bgc_00a0e9 c_fff text-center m_l10 f_l cursor_ Save_ Save1">
											保存</div>
										<div id="cancel"
...
//		 		document.getElementById(fomrId).submit();
	...
	$(function(){
		var buttonId = $("#buttonId").val();
		if(buttonId == '0'){
			$("#addstatus").val("已开启签收提醒");
		}
		if(buttonId == '1'){
			$("#addstatus").val("已关闭签收提醒");
		}
	});
	//获取开启或关闭状态
	function addstatus(){
